...
<p class="bg-white text-center text-lg text-gray-700">Felton 2013 Bar Chart</p>
<svg
...
>
	{#each topParticipants as participant, i}
		...
		<text class="label highlight" text-anchor="end" x={xScale(xMax ? xMax : 0)} y={yOffsetFn(i)}
